...
import 'search_households_smc.dart' as search_households_smc;
...
class NonComplianceIndividualSearchBloc extends SearchHouseholdsSMCBloc {
  NonComplianceIndividualSearchBloc(
    ...
    on<search_households_smc.IndividualGlobalSearchSMCEvent>(
        _individualGlobalSearch);
  }

  Future<void> _individualGlobalSearch(
    search_households_smc.IndividualGlobalSearchSMCEvent event,
    search_households_smc.SearchHouseholdsSMCEmitter emit,
  ) async {
